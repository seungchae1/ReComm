...
public class RecyclerView_Rank_2 extends RecyclerView.Adapter<RecyclerView_Rank_2.ViewHolder> {
    private Context context;

    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView mainImg;
        TextView rankText, titleText, writerText;
    ...
    public RecyclerView_Rank_2(ArrayList<RecyclerViewItem> mList, Context context) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recomm_rank5_2, parent, false);
        RecyclerView_Rank_2.ViewHolder vh = new RecyclerView_Rank_2.ViewHolder(view);
        return vh;
    }

    // position에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시
    @Override
    public void onBindViewHolder(@NonNull RecyclerView_Rank_2.ViewHolder holder, int position) {
